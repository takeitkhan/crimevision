...
export default function National() {
    ...
    useEffect(() => {
        axiosInstance.get('/posts?term_type=news&category_slug=national&order_by=desc&per_page=8')
            .then(response => {
            ...
            <div className="container pt-10">
                <div class="text-center mb-5">
                    <div className="border-b border-custom">
                        <h2 className="border-b-2 border-black-400 text-2xl inline font-extrabold">জাতীয়</h2>
                    </div>
                </div>
                <div className="">
