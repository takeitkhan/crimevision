...
export default function International() {
    ...
    useEffect(() => {
        axiosInstance.get('/posts?term_type=news&category_slug=international&order_by=desc&per_page=20')
            .then(response => {
            ...
            <div class="container pt-10">
                <div class="text-center mb-5">
                    <div class="border-b border-custom">
                        <h2 class="border-b-2 border-black-400 text-2xl inline font-extrabold">আন্তর্জাতিক</h2>
                    </div>
                </div>
                <div class="">
